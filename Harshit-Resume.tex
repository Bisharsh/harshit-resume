...
DevOps Engineer with 3+ years of hands-on experience designing and operating Kubernetes, helmcharts, CI/CD and automated cloud infrastructure. Strong focus on reliability, security, and developer experience, with proven impact in reducing operational bottlenecks, enabling release strategies, and owning scalable production systems.
% Passionate DevOps Engineer with 3+ years of experience specializing in automation, cloud infrastructure \& kubernetes. Proven track record of reducing CI/CD bottlenecks, secret management, optimizing k8s clusters \& deployments, writing clear documentations, designing resilient CI/CD pipelines and reducing downtime.
...
\begin{dashlist}
    ...
    \item \uline{PR enhancement workflow}: Introduced a github actions workflow to provide soft guidance to dev/review via comments on PRs, based on the conventional commit types.
    ...
    \item \uline{Introduced e2e testing}: Designed \& implemented end-to-end testing in the cd \& release AzDO pipeline, writing jest based tests.
\end{dashlist}
\medskip
...
\begin{flushright} % Aligns text to the right
    \textit{Date: 09.01.2025}\\ % Adds the date below the name
