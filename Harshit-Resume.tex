...
\begin{dashlist}
    ...
    \item \uline{k8s lease}: Implemented a Kubernetes Lease-based leader election mechanism to ensure to avoid multiple cronjob runs. 
...
\begin{flushright} % Aligns text to the right
    \textit{Date: 07.12.2025}\\ % Adds the date below the name
