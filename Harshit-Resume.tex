...
\begin{dashlist}
    ...
    \item \uline {Multi-region infrastructure management}: Provisioned \& maintained Azure infrastructure for ChatPwC across EMEA \& US using Terraform modules \& Azure DevOps.
...
\begin{flushright} % Aligns text to the right
    \textit{Date: 22.01.2025}\\ % Adds the date below the name
